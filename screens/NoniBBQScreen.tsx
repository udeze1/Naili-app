...
export default function NoniBBQScreen() {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backRow}>
        ...
        <Text style={styles.title}>Noni BBQ</Text>
      </TouchableOpacity>

      <Text style={styles.energyHeader}>🔥 Ime ọkụ na-esi nri ụtọ</Text>
      <Text style={styles.quote}>“Ọkụ dị n’ụlọ na-enye ndụ ụtọ.”</Text>
